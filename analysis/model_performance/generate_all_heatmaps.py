...
def create_heatmap(matrix_file, statement_info_file, title, output_name, row_color_func, row_legend_items=None):
    ...
    # Set index to statement_index for reliable .loc[] lookups
    statement_info = statement_info.set_index('statement_index')
    ...
    tracker.add_output_file(output_path, 'Heatmap visualization')
